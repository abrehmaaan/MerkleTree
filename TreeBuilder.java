...
public class TreeBuilder 
{
	...
	public static void main(String[] noargs) 
	{
		...
		final byte[] block1 = {'D', 'a', 't', 'a', ' ', 'S', 't', 'r', 'u', 'c', 't', 'u', 'r', 'e', 's'};
		final byte[] block2 = {'A', 'B', 'C'};
		final byte[] block3 = {'H', 'a', 's', 'h', 'i', 'n', 'g'};
		final byte[] block4 = {'T', 'r', 'e', 'e', 's'};
		final byte[] block5 = {'M','e','r','k','l','e'};
		final byte[] block6 = {'B','i','n','a','r','y',' ','T','r','e','e','s'};
		final byte[] block7 = {'C','o','l','l','e','g','e',' ','o','f',' ','E','n','g','i','n','e','e','r','i','n','g'};
		final byte[] block8 = {'A','l',' ','A','i','n'};
